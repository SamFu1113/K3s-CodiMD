...
### What is CodiMD
- CodiMD is the free software version of [HackMD](https://hackmd.io/ "Title"), developed and opened source by the HackMD team with reduced features (without book mode), you can use CodiMD for your community and own all your data.
...
**Deployments**
> 	&nbsp;&nbsp;&nbsp;&nbsp;A Deployment provides declarative updates for Pods ReplicaSets.<br/>
