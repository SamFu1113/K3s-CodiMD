...
- Automatic bin packing: You provide K8s with a cluster of nodes that it can use to run containerized tasks. I could tell Kubernetes how much CPU and memory (RAM) each container needs.
